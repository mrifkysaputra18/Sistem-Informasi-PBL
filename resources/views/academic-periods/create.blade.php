                    ...
                    <form action="{{ route('academic-periods.store') }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" 
                                   ...
                                   class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 @error('academic_year') border-red-500 @enderror">
                            @error('academic_year')
                        ...
                        <div class="mb-6">
                            ...
                            <select name="semester_number" 
                                    id="semester_number" 
                                    required
                                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 @error('semester_number') border-red-500 @enderror">
