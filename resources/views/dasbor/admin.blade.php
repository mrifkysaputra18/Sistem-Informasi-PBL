            ...
            <div class="bg-white rounded-xl shadow-md p-5">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    ...
                    <a href="{{ route('nilai-rubrik.index') }}" 
                       class="flex items-center gap-4 p-4 bg-orange-50 border border-orange-200 hover:bg-orange-100 rounded-xl transition-colors">
                        <div class="bg-orange-500 p-3 rounded-xl shadow flex items-center justify-center">
                            <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                            </svg>
                        </div>
                        <div>
                            <p class="font-bold text-gray-900">Nilai Mata Kuliah</p>
                            <p class="text-sm text-gray-600">Input nilai rubrik</p>
                        </div>
                    </a>
                </div>
            </div>
