    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-8">
                    <form action="{{ route('weekly-targets.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    <p class="text-sm text-blue-700">
                                        <strong>Tips:</strong> Buat target yang spesifik dan terukur untuk minggu ini. 
                                        Semakin banyak target yang diselesaikan, semakin baik nilai kecepatan progres kelompok Anda!
                                    </p>
                                </div>
                            </div>
                        </div>
