            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-8">
                    ...
                    <div class="mb-8 text-center">
                        ...
                        <h3 class="text-2xl font-bold text-gray-900 mb-2">Edit Semester</h3>
                        <p class="text-gray-600">Update informasi semester {{ $semester->name }}</p>
                    </div>
                            ...
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    <p class="text-sm text-yellow-700">
                                        <strong>Perhatian:</strong> Perubahan pada semester akan mempengaruhi {{ $semester->classrooms_count ?? 0 }} kelas yang terkait.
                                    </p>
                                </div>
                            </div>
                        </div>
