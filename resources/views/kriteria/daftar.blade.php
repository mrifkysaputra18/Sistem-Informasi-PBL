{{-- View: Daftar Kriteria | Controller: KriteriaController@index | Route: criteria.index --}}
<x-app-layout>
    <div class="py-8 bg-gray-100 min-h-screen font-sans">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {{-- Alert: Pesan sukses dari session --}}
            @if(session('ok'))
            ...
            {{-- Stats Cards: Statistik kriteria --}}
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                ...
                {{-- Kriteria Benefit (makin tinggi makin baik) --}}
                ...
                {{-- Kriteria Cost (makin rendah makin baik) --}}
                    ...
                    @if($criteria->count() > 0)
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                {{-- Loop data kriteria dari controller --}}
                                ...
                                <tr class="hover:bg-indigo-50 transition-colors group">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            ...
                                            {{-- Progress bar visual untuk bobot --}}
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center border-l border-gray-100">
                                        <div class="flex items-center justify-center gap-2">
                                            ...
                                            {{-- Form Hapus dengan CSRF & method DELETE --}}
    ...
    {{-- Script konfirmasi hapus dengan SweetAlert --}}
    @push('scripts')
    <script>
