            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-8">
                    ...
                    <div class="mb-8 text-center">
                        ...
                        <h3 class="text-2xl font-bold text-gray-900 mb-2">Edit Mata Kuliah</h3>
                        <p class="text-gray-600">Update informasi mata kuliah {{ $subject->title }}</p>
                    </div>

                    <form action="{{ route('projects.update', $subject) }}" method="POST">
                        @csrf
                        @method('PUT')
